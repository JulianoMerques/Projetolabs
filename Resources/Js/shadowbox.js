        ...
        if (S.options.displayCounter && S.gallery.length > 1) {
            ...
            if (S.options.counterType === "skip") {
                ...
                if (limit < len && limit > 2) {
                    var h = options.counterFromCurrent ? 0 : Math.floor(limit / 2);;
//                    var h = Math.floor(limit * 2);
    ...
    var K = {};
    K.markup = '<div id="sb-container">\n\
<div id="sb-overlay"></div>\n\
<div id="sb-wrapper"><div id="sb-title"><div id="sb-title-inner"></div></div>\n\
<div id="sb-wrapper-inner"><div id="sb-body"><div id="sb-body-inner"></div>\n\
<div id="sb-loading"><div id="sb-loading-inner"><span>{loading}</span>\n\
</div></div></div></div><div id="sb-info"><div id="sb-info-inner">\n\
<div id="sb-counter"></div><div id="sb-nav"><a id="sb-nav-close" title="{close}" onclick="Shadowbox.close()"></a>\n\
<a id="sb-nav-next" title="{next}" onclick="Shadowbox.next()"></a>\n\
<a id="sb-nav-play" title="{play}" onclick="Shadowbox.play()"></a>\n\
<a id="sb-nav-pause" title="{pause}" onclick="Shadowbox.pause()"></a>\n\
<a id="sb-nav-previous" title="{previous}" onclick="Shadowbox.previous()"></a></div></div></div></div></div>';
    K.options = {animSequence: "sync", counterLimit: 50, counterType: "skip", counterFromCurrent:true ,
                displayCounter: true, displayNav: true, fadeDuration: 0.35, initialHeight: 160,
                initialWidth: 320, modal: false, overlayColor: "#000", overlayOpacity: 0.5,
                resizeDuration: 0.35, showOverlay: true, troubleElements: ["select", "object", "embed", "canvas"]};
    K.init = function() {

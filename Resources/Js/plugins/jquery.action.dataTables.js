...
//funcoes que devem ser rechamadas quando acontecem chamadas assÃ­ncronas
function load() {
    Sys.WebForms.PageRequestManager.getInstance().add_endRequest(EndRequestHandler);
}

//o que deseja fazer quando terminar a requisiÃ§Ã£o de um update panel?

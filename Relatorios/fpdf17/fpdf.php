...
//     $this->Image('resources/img/organisation-option.png',100,1,30);
     $this->Image('../Resources/Img/logo.png',40,5,50);
	...
	$this->Ln(20);
     ...
     $this->Cell(330,1.5,  utf8_decode('.:: Sistema de Controle de Manutenção ::.'),0,0,'C');	
...
function Footer()
{
    ...
    // Definimos a fonte
     ...
     $this->Cell(4,1.5,  utf8_decode('.:: Sistema de Controle de Manutenção ::.'),0,0,'C','');
...
//     $this->Cell(4,1.5,'Gerado em:',0,0,'R');
 
     	$data = date('d-m-Y');
        $hora = date('H:i:s');
        $this->Cell(35,1.5,'Gerado em:'.$data.' | '.$hora,0,0,'R');
}
